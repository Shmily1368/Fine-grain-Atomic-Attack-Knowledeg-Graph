...
// To use the GUIDs, copy the GUID definitions that you want to use to your source code. 
// You must include #define INITGUID before the definitions you include in your source code, 
// so the compiler will turn the DEFINE_GUID into a constant GUID. For example,
